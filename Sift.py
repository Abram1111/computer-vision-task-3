...
def computeNumberOfOctaves(image_shape):
    ...
    """
    """ calculate the number of times where we can halve the image until it becomes indivisible then we round 
    the image to the nearest integer to have an integer number of layers in our image.Which ensures 
    the image in the highest octave (the smallest image) will have a side length of at least 3."""
...
def apply_sift(img):
    ...
    out = cv2.drawKeypoints(img, keypoints, 0, (255, 0, 0),
